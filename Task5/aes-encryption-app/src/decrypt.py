import time
from file_utils import read_file, write_file, hex_to_bytes, bytes_to_hex
...
def aes_decrypt_block(block, key):
    ...
    decrypted_block = [state[j][i] for i in range(4) for j in range(4)]
...
def decrypt_file(input_file, output_file, key):
    ...
    with open(output_file, 'w') as f:
        f.write(''.join(chr(byte) for byte in plaintext if byte != 0))
...
if __name__ == "__main__":
    ...
    decrypt_file('ciphertext.txt', 'decrypted.txt', key)